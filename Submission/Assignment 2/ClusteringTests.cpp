...
TEST(KMeans, Iris)
{
	...
	Dataset trainSet = { dataset.begin(), dataset.begin() + 75 };
	trainSet.insert(trainSet.end(), dataset.begin() + 50, dataset.begin() + 75 );
	trainSet.insert(trainSet.end(), dataset.begin() + 100, dataset.begin() + 125);

	Dataset testSet = { dataset.begin() + 25, dataset.begin() + 50 };
	testSet.insert(testSet.end(), dataset.begin() + 75, dataset.begin() + 100);
	testSet.insert(testSet.end(), dataset.begin() + 125, dataset.begin() + 150);
    // STUDENT TEST

	KMeans kMeans = KMeans(trainSet, { trainSet[0], trainSet[25], trainSet[50] }, false);
